...
// Add Prettier-pragma and prettify
execSync(
  `./node_modules/.bin/prettier --insert-pragma --require-pragma=false --ignore-path .eslintignore --write ${files.join(
    ' ',
  )}`,
);

console.log('Done prettifying!');
console.log('Now add these files to .eslintrc.js');
